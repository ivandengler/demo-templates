...
const tours = [
  ...
  {
    id: 4,
    name: { en: 'Chiang Mai Night Safari', es: 'Safari Nocturno de Chiang Mai', de: 'Chiang Mai Nachtsafari', pt: 'Safari Noturno de Chiang Mai', it: 'Safari Notturno di Chiang Mai', ru: 'Ночное сафари Чиангмай', zh: '清迈夜间野生动物园', ja: 'チェンマイ・ナイトサファリ', ko: '치앙마이 나이트 사파리', th: 'ไนต์ซาฟารีเชียงใหม่' },
    location: 'Chiang Mai Night Safari Park',
    duration: { en: 'Evening', es: 'Noche', de: 'Abend', pt: 'Tarde/noite', it: 'Sera', ru: 'Вечер', zh: '夜间', ja: '夜', ko: '저녁', th: 'ช่วงเย็น' },
    groupSize: 'Max 12',
    difficulty: 'easy',
    rating: 4.7,
    reviews: 156,
    price: 1200,
    currency: 'THB',
    badge: { en: 'Night adventure', es: 'Aventura nocturna', de: 'Nacht-Abenteuer', pt: 'Aventura noturna', it: 'Avventura notturna', ru: 'Ночное приключение', zh: '夜间探险', ja: '夜の冒険', ko: '야간 모험', th: 'ผจญภัยยามค่ำคืน' },
    badgeColor: 'bg-slate-700',
    description: {
      en: "One of Asia's top-rated wildlife parks after dark. Ride the tram through predator zones and stroll the savanna trail to see tigers, lions, deer and hundreds of nocturnal animals in action.",
      es: 'Uno de los mejores parques de vida silvestre de Asia después del anochecer. Recorré en tram las zonas de depredadores y paseá por la sabana para ver tigres, leones y cientos de animales nocturnos.',
    },
    highlights: {
      en: ['Tram ride through predator zone', 'Savanna trail on foot', 'Tigers, lions, bears & deer', 'Entry ticket + hotel transfer included'],
      es: ['Recorrido en tram por zona de depredadores', 'Sendero de sabana a pie', 'Tigres, leones, osos y venados', 'Entrada + traslado al hotel incluido'],
    },
    images: [
      'https://images.unsplash.com/photo-1549366021-9f761d040a94?w=800&q=85&auto=format&fit=crop',
    ...
    dates: [
      { date: '2026-08-08', spots: 9 },
      { date: '2026-08-10', spots: 5 },
      { date: '2026-08-12', spots: 12 },
      { date: '2026-08-15', spots: 3 },
      { date: '2026-08-17', spots: 8 },
    ],
