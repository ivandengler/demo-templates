    ...
    <div className="min-h-screen bg-[#1A1A1A] text-white font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#1A1A1A]/95 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div>
            <span className="text-[#D4A853] font-bold text-xl tracking-tight">Ristorante</span>
            <span className="text-white font-light text-xl ml-1">Saveur</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-white/60 leading-relaxed mb-4">
              Saveur nació de la obsesión de nuestro chef por los mercados de temporada y las técnicas aprendidas en Lyon, París y Barcelona. Cada plato es un puente entre la tradición europea y el producto local.
            </p>
      ...
      <footer className="border-t border-white/5 py-10 text-white/30 text-sm">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <span className="text-white/60 font-semibold">Ristorante Saveur · Rosario</span>
          <p>© 2025 Saveur. Todos los derechos reservados.</p>
